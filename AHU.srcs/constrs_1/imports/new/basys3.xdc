...
set_property -dict { PACKAGE_PIN G2   IOSTANDARD LVCMOS33 } [get_ports {buzzer}];#Sch name = JA4
...
##Pmod Header JB
set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS33 } [get_ports {ds1302_sclk}];#Sch name = JB1
set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS33 } [get_ports {ds1302_data}];#Sch name = JB2
set_property -dict { PACKAGE_PIN B15   IOSTANDARD LVCMOS33 } [get_ports {ds1302_ce}];#Sch name = JB3
...
##Pmod Header JXADC
set_property -dict { PACKAGE_PIN J3   IOSTANDARD LVCMOS33 } [get_ports {dht11_data}]; #Sch name = XA1_P
# set_property -dict { PACKAGE_PIN L3   IOSTANDARD LVCMOS33 } [get_ports {JXADC[1]}]; #Sch name = XA2_P
# set_property -dict { PACKAGE_PIN M2   IOSTANDARD LVCMOS33 } [get_ports {JXADC[2]}]; #Sch name = XA3_P
#set_property -dict { PACKAGE_PIN N2   IOSTANDARD LVCMOS33 } [get_ports {JXADC[3]}];#Sch name = XA4_P
# set_property -dict { PACKAGE_PIN K3   IOSTANDARD LVCMOS33 } [get_ports {ds1302_sclk}];#Sch name = XA1_N
# set_property -dict { PACKAGE_PIN M3   IOSTANDARD LVCMOS33 } [get_ports {ds1302_data}];#Sch name = XA2_N
# set_property -dict { PACKAGE_PIN M1   IOSTANDARD LVCMOS33 } [get_ports {ds1302_ce}];#Sch name = XA3_N
...
set_property PULLUP true [get_ports ds1302_data]
